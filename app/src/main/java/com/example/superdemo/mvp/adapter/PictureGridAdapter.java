package com.example.superdemo.mvp.adapter;
...
import com.example.superdemo.ui.widget.RatioImageView;
...
public class PictureGridAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof ItemViewHolder){
            ...
            CommonUtils.loadGlideImage(context, pictureBody.list.get(0).middle, viewHolder.iv_picture);
