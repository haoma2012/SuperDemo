package com.example.superdemo.mvp.server;

import android.support.annotation.NonNull;

import com.example.superdemo.MyApplication;
import com.example.superdemo.mvp.common.BizInterface;
...
//            Cache cache = new Cache(cacheFile, 1024 * 1024 * 100); // 指定缓存大小100Mb
            ...
            Interceptor rewriteCacheControlInterceptor = new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    ...
                    if (!CommonUtils.isConnected(MyApplication.getInstance().getApplicationContext())) {
...
//                            .connectTimeout(30, TimeUnit.SECONDS).build();
    ...
    public static String getCacheControl() {
        return CommonUtils.isConnected(MyApplication.getInstance().getBaseContext()) ? CACHE_CONTROL_NETWORK : CACHE_CONTROL_CACHE;
    }
}
