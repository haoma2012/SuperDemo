...
public class LubaImageCompress {
     ...
     * @return
     */
    public static File thirdCompress(@NonNull File file, String thumb) {
...
//                (TextUtils.isEmpty(filename) ? System.currentTimeMillis() : filename);
    ...
    public static File firstCompress(@NonNull File file, String thumbFilePath) {
        int minSize = 60;
        int longSide = 720;
        int shortSide = 1280;
...
//        String thumbFilePath = mCacheDir.getAbsolutePath() + File.separator + (TextUtils.isEmpty(filename) ? System.currentTimeMillis() : filename);
     ...
     */
    public static File compress(String largeImagePath, String thumbFilePath, int width, int height, int angle, long size) {
