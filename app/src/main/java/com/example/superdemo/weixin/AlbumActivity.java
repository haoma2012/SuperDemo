...
import com.example.superdemo.MainActivity;
import com.example.superdemo.MyApplication;
import com.example.superdemo.R;
import com.example.superdemo.utils.AlbumHelper;
                ...
                .setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (isChecked) {
                            ...
                            chooseBt.setVisibility(View.GONE);
                            okButton.setText(Res.getString("finish") + "(" + Bimp.tempSelectBitmap.size() + "/" + 9 + ")");
                        }
                        isShowOkBt();
                    }
                });
